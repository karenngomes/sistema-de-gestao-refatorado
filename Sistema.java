...
public class Sistema {
	...
	static Object login(ArrayList listaUsuarios)
	{
		int index = -1;
	...
	static RecursosUA createRecurso(Usuario user, Usuario responsavel)
	{
		...
		else
		{
			...
			DataHora inicio = new DataHora(dia, mes, ano, hora, minuto, 1);
			...
			DataHora termino = new DataHora(dia, mes, ano, hora, minuto, 2);
	...
	public static void main(String[] args) {
		...
		listaUsuarios.add(users);
		users = new Usuario("student", "Jorge Silva", "jorge@gmail.com", 2);
		listaUsuarios.add(users);
